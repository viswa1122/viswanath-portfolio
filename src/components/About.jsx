          ...
          <div className="p-2">
            <div className="text-gray-500 my-3">
              <p className="text-justify leading-7 w-11/12 mx-auto">
                Overall of 5+ years of working experience in Amazon Web Services environment and DevOps. Experienced cloud and DevOps engineer in automation, configuration and deployment of AWS cloud infrastructure.
              </p>
